...
export default function Home() {
  ...
  useEffect(() => {
    const fetchAnime = async () => {
      const { data: trendingData } = await axios.get("https://animeapi.skin/api/anime/trending");
      const { data: latestData } = await axios.get("https://animeapi.skin/api/anime/latest");
